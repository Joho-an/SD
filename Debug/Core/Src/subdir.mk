...
../Core/Src/bmp_decode.c \
../Core/Src/dma.c \
../Core/Src/file_browser.c \
../Core/Src/freertos.c \
../Core/Src/gpio.c \
../Core/Src/i2s.c \
../Core/Src/lcd_chinese.c \
../Core/Src/lcd_st7735.c \
../Core/Src/main.c \
../Core/Src/sdio.c \
../Core/Src/spi.c \
...
./Core/Src/bmp_decode.o \
./Core/Src/dma.o \
./Core/Src/file_browser.o \
./Core/Src/freertos.o \
./Core/Src/gpio.o \
./Core/Src/i2s.o \
./Core/Src/lcd_chinese.o \
./Core/Src/lcd_st7735.o \
./Core/Src/main.o \
./Core/Src/sdio.o \
./Core/Src/spi.o \
...
./Core/Src/bmp_decode.d \
./Core/Src/dma.d \
./Core/Src/file_browser.d \
./Core/Src/freertos.d \
./Core/Src/gpio.d \
./Core/Src/i2s.d \
./Core/Src/lcd_chinese.d \
./Core/Src/lcd_st7735.d \
./Core/Src/main.d \
./Core/Src/sdio.d \
./Core/Src/spi.d \
...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/audio_player.cyclo ./Core/Src/audio_player.d ./Core/Src/audio_player.o ./Core/Src/audio_player.su ./Core/Src/bmp_decode.cyclo ./Core/Src/bmp_decode.d ./Core/Src/bmp_decode.o ./Core/Src/bmp_decode.su ./Core/Src/dma.cyclo ./Core/Src/dma.d ./Core/Src/dma.o ./Core/Src/dma.su ./Core/Src/file_browser.cyclo ./Core/Src/file_browser.d ./Core/Src/file_browser.o ./Core/Src/file_browser.su ./Core/Src/freertos.cyclo ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/freertos.su ./Core/Src/gpio.cyclo ./Core/Src/gpio.d ./Core/Src/gpio.o ./Core/Src/gpio.su ./Core/Src/i2s.cyclo ./Core/Src/i2s.d ./Core/Src/i2s.o ./Core/Src/i2s.su ./Core/Src/lcd_chinese.cyclo ./Core/Src/lcd_chinese.d ./Core/Src/lcd_chinese.o ./Core/Src/lcd_chinese.su ./Core/Src/lcd_st7735.cyclo ./Core/Src/lcd_st7735.d ./Core/Src/lcd_st7735.o ./Core/Src/lcd_st7735.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/sdio.cyclo ./Core/Src/sdio.d ./Core/Src/sdio.o ./Core/Src/sdio.su ./Core/Src/spi.cyclo ./Core/Src/spi.d ./Core/Src/spi.o ./Core/Src/spi.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_hal_timebase_tim.cyclo ./Core/Src/stm32f4xx_hal_timebase_tim.d ./Core/Src/stm32f4xx_hal_timebase_tim.o ./Core/Src/stm32f4xx_hal_timebase_tim.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su
